...
id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY, nome VARCHAR(100) NOT NULL, 
...
if ($metodoHttp == 'POST') {
	...
	$jsonArray = array();
	$sql = "SELECT id,nome,estrelas from hotel_db.Hotel";
	...
	$stmt = $conn->prepare("DELE FROM hotel_db.Hotel WHERE id=?");
